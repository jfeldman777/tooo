...
(function (global) {
  ...
  const STRINGS = {
    ru: {
      ...
      browseAria: "Примеры картинок",
      browseTitle: "Примеры: выбрать таблицу и ступень 1–8",
      browseTable: "Таблица",
      browseExit: "К игре",
      browseHint: "Выберите таблицу и нажмите ступень 1–8 слева",
      browseMeta: "Примеры · {table} · ступень {n}",
      browseMissing: "Нет картинки для ступени {n}",
    ...
    en: {
      ...
      browseAria: "Picture examples",
      browseTitle: "Examples: pick a table and a step 1–8",
      browseTable: "Table",
      browseExit: "Back to game",
      browseHint: "Pick a table, then tap a step 1–8 on the left",
      browseMeta: "Examples · {table} · step {n}",
      browseMissing: "No image for step {n}",
